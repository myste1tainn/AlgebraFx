...
extension Single {
  ...
  public static func >-><R: Single>(left: Self, right: @escaping (E) -> R) -> Single<R.E> {
    return left.flatMap { l in right(l) }
  }
  
  public static func >-><R: Single>(left: Self, right: @escaping (E) -> R) -> Single<R.E> where E: OptionalType {
    return left.flatMap { l in right(l) }
  }
}
